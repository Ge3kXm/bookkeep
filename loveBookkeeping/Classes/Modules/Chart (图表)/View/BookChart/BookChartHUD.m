...
@property (nonatomic, strong) XMBCHUDContent *content;
...
- (XMBCHUDContent *)content {
    if (!_content) {
        _content = [XMBCHUDContent loadCode:CGRectMake(0, 0, SCREEN_WIDTH / 2, countcoordinatesX(120))];
