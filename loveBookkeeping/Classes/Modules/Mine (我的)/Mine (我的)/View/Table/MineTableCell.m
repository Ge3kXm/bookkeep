...
- (void)setBadgeCount:(NSInteger)badgeCount {
    ...
    [_detailLab setAttributedText:({
        ...
        NSAttributedString *attr1 = [[NSAttributedString alloc] initWithString:@"当前等级为" attributes:param1];
        NSAttributedString *attr2 = [[NSAttributedString alloc] initWithString:[@(_badgeCount) description] attributes:param2];
        NSAttributedString *attr3 = [[NSAttributedString alloc] initWithString:@"级" attributes:param1];
