...
#import "MYXAppDelegate.h"
#import "AppDelegate+UMeng.h"


#pragma mark - 声明
@interface MYXAppDelegate ()

@end


#pragma mark - 实现
@implementation MYXAppDelegate
...
- (BOOL)application:(UIApplication *)app openURL:(NSURL *)url options:(NSDictionary<UIApplicationOpenURLOptionsKey, id> *)options {
    ...
    if ([url.absoluteString isEqualToString:@"kbook://month"]) {
        ...
        BOOL condition2 = ![[UIViewController getCurrentVC] isKindOfClass:[MXLoveBKCController class]];
