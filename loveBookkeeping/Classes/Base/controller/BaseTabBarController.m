...
- (void)viewDidLoad {
    ...
    MXMyHomeController *home = [[MXMyHomeController alloc] init];
    [self addChildViewController:home title:@"" image:@"tabbar_detail_n" selImage:@"tabbar_detail_s"];
...
//    [self addChildViewController:sort title:@"图表" image:@"tabbar_chart_n" selImage:@"tabbar_chart_s"];
    ...
    XMBaseViewController *message = [[XMBaseViewController alloc] init];
    [self addChildViewController:message title:@"" image:@"tabbar_add_n" selImage:@"tabbar_add_h"];
...
//    [self addChildViewController:cart title:@"发现" image:@"tabbar_discover_n" selImage:@"tabbar_discover_s"];
    ...
    XMMineController *mine = [[XMMineController alloc] init];
    [self addChildViewController:mine title:@"" image:@"tabbar_mine_n" selImage:@"tabbar_mine_s"];
...
- (void)addChildViewController:(XMBaseViewController *)childVc title:(NSString *)title image:(NSString *)image selImage:(NSString *)selImage {
...
- (BaseTabBar *)bar {
    if (!_bar) {
        ...
        [_bar setClick:^(NSInteger index) {
            ...
            // 记账
            if (index == 1) {
                MXLoveBKCController *vc = [[MXLoveBKCController alloc] init];
                ...
                if (index == 2) {
                    ...
                    XMMineController *vc = nav.viewControllers[0];
