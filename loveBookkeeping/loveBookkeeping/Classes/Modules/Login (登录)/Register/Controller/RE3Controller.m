...
- (void)registerRequest {
    ...
    @weakify(self)
    [AFNNetworkManager POST:RegisterRequest params:param complete:^(MXAPPResult *result) {
        @strongify(self)
        [self hideHUD];
...
- (void)forgetRequest {
    ...
    [self showProgressHUD];
    @weakify(self)
    [AFNNetworkManager POST:ForgetPassRequest params:param complete:^(MXAPPResult *result) {
        @strongify(self)
        [self hideHUD];
        if (result.status == ServiceCodeSuccess) {
            [UserInfo saveUserInfo:result.data];
...
- (void)bindPhoneRequest {
    ...
    [self showProgressHUD];
    @weakify(self)
    [AFNNetworkManager POST:BindPhoneRequest params:param complete:^(MXAPPResult *result) {
        @strongify(self)
        [self hideHUD];
        if (result.status == ServiceCodeSuccess) {
