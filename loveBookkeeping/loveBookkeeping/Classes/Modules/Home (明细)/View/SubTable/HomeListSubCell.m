...
- (void)initUI {
    ...
    [self.nameLab setFont:[UIFont systemFontOfSize:AdjustFont(15) weight:UIFontWeightLight]];
    [self.nameLab setTextColor:kColor_Text_Black];
    [self.detailLab setFont:[UIFont systemFontOfSize:AdjustFont(15) weight:UIFontWeightLight]];
