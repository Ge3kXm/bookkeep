...
#pragma mark - 实现
@implementation XMACAController
...
- (void)getCategoryListRequest {
    @weakify(self)
    [self.collection createRequest:CustomerCategoryListRequest params:@{} complete:^(MXAPPResult *result) {
        @strongify(self)
...
- (void)addCategoryRequest {
    ...
    [AFNNetworkManager POST:AddInsertCategoryListRequest params:param complete:^(MXAPPResult * _Nonnull result) {
        @strongify(self)
        [self hideHUD];
