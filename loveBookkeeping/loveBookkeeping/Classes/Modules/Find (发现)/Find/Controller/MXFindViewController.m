...
#import "MXFindViewController.h"
#import "FindFeatureCell.h"
#import "MXMyBillController.h"
#import "FindBookCell.h"
#import "XXXCCController.h"
#import "ACController.h"

#pragma mark - 声明
@interface MXFindViewController()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
#pragma mark - 实现
@implementation MXFindViewController
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        MXMyBillController *vc = [[MXMyBillController alloc] init];
        [self.navigationController pushViewController:vc animated:true];
    } else if (indexPath.section == 1) {
        if (indexPath.row == 0) {
            XXXCCController *vc = [[XXXCCController alloc] init];
            [self.navigationController pushViewController:vc animated:true];
