...
- (void)setLeftBtn {
    ...
    if ([self isKindOfClass:[MXMyHomeController class]] ||
        [self isKindOfClass:[XMYChartController class]] ||
        [self isKindOfClass:[MXLoveBKCController class]] ||
        [self isKindOfClass:[MXFindViewController class]] ||
        [self isKindOfClass:[XMMineController class]]) {
